...
def test_diff_fields_reported():
    planned = [
        {"source": "a.mkv", "dest": "Movie/Movie.mkv", "resolution": "2160p", "codec": "hevc"},
        {"source": "b.mkv", "dest": "Movie/Movie.mkv", "resolution": "1080p", "codec": "hevc"},
    ]
    collisions = detect_collisions(planned, existing_paths=set())
...
def test_three_way_collision():
    planned = [
        {"source": "a.mkv", "dest": "Movie/Movie.mkv", "resolution": "2160p"},
        {"source": "b.mkv", "dest": "Movie/Movie.mkv", "resolution": "1080p"},
        {"source": "c.mkv", "dest": "Movie/Movie.mkv", "resolution": "720p"},
    ]
    collisions = detect_collisions(planned, existing_paths=set())
    assert len(collisions) == 1
...
def test_multiple_destinations_collide_independently():
    planned = [
        {"source": "a.mkv", "dest": "Movie1/Movie1.mkv"},
        {"source": "b.mkv", "dest": "Movie1/Movie1.mkv"},
        {"source": "c.mkv", "dest": "Movie2/Movie2.mkv"},
        {"source": "d.mkv", "dest": "Movie2/Movie2.mkv"},
    ]
    collisions = detect_collisions(planned, existing_paths=set())
